...
var modifyDefaultMapPopup = function(eventDispatcher, popup){
  ...
  var loadContentHTML = function(htmlStr){
  ...
  popup.loadContentHTML = loadContentHTML.bind(popup);
